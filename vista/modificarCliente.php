            ...
            <div id="panelDer">
               ...
               require_once '../modelo/dto/ClienteDTO.php';
                ...
                <form class="formRegistro"  id="formClientes" method="Get" action="../controlador/ControladorClientes.php"> 
                    ...
                    <input class="input" name="idCliente" value ="<?php echo $usuario['idUsuario']; ?>" required type="number" pattern="[0-9]{1,15}"  title="Dato no modificable" maxlength="128" id="txtEmail" class="field1" style="text-align: center" readonly>
                    ...
                    <input class="input" name="nombreCompania" value ="<?php echo $cliente['nombreCompania']; ?>" required type="text" maxlength="64" id="txtCompany1" class="field1" autofocus placeholder="Muebles la Oficina" >
                    <span id="valCompany" style="color:Red;visibility:hidden;"></span>
                    <br>   
                    ...
                    <select class="input" name="sectorEmp" id="selCountry" class="list_menu">                                              
                        <option value="<?php echo $cliente['sectorEmpresarial']; ?>"><?php echo $cliente['sectorEmpresarial']; ?></option>
                    ...
                    <option value="<?php echo $cliente['sectorEconomico']; ?>"><?php echo $cliente['sectorEconomico']; ?></option>                                                                     
                    <optgroup label="Cambiar a :"> 
                        ...
                        <option value="Minero" >Minero y Energético</option>
                    ...
                    <input class="input" name="direccion" value="<?php echo $usuario['direccion']; ?>" type="text" id="txtSurname" placeholder="Cll 93 No 15 - 99" class="field1">
                    ...
                    <input class="input" name="telefonoFijo" value ="<?php echo $cliente['telefonoFijo']; ?>" sibility:hidden></span>
                    <hr>
                    ...
                    <input class="input" name="nombre" type="text" value="<?php echo $usuario['nombres']; ?>"id="txtName" class="field1" placeholder="Pedro"  required pattern= [A-Za-z]{3,} "">
                    ...
                    <input class="input" name="identificacion" value="<?php echo $usuario['identificacion']; ?>" required type="text" pattern="[0-9]{6,15}" placeholder="1033405321" title="Solo números" maxlength="128" id="documento" class="field1">
                    <span id="valCompany" style="color:Red;visibility:hidden;"></span>
                    <br>   
                    <label class="tag" for="txtNit"><span id="lab_valCompany1" class="h331">Teléfono: </span></label>
                    <input class="input" name="telefono" value="<?php echo $usuario['telefono']; ?>" required type="text" size= "5" id="txtNit" class="field1" placeholder="3104450321" autofocus pattern="[0-9]{7,10}">                       
                    <span id="valSurname" style="color:Red;visibility:hidden;"></span>
                    <br>
                    <label class="tag" for="txtEmail"><span id="lab_valEmail" class="h331">E-mail: </span></label>
                    <input class="input" name="email" value="<?php echo $usuario['email']; ?>" required type="text" maxlength="128" id="txtEmail" class="field1" placeholder="empleado@muebleslaoficina.com" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
