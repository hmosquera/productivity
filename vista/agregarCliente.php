...
<?php } ?>
                ...
                <span itemscope >
                    ...
                    <span itemprop="child" itemscope>  
                        <a href="clientesActivos" title="Clientes" itemprop="url">
                            <span itemprop="title">Clientes Activos</span>              
                        </a>  > 
            ...
            <div id="panelDer">
                ...
                <form class="formRegistro"  id="formClientes" method="post" action="../controlador/ControladorClientes.php" enctype="multipart/form-data"> 
                    ...
                    <input class="input" name="telefonoFijo" required type="text" size= "5" id="teFijo" class="field1" placeholder="3691196" autofocus pattern="[0-9]{7,10}">                       
                    <span id="valSurname" style="color:Red;visibility:hidden;"></span>
                     <br>
                    <label class="tag1" for="image"><span id="lab_valCompany" class="h331">Logo:</span></label>
